...
public class MergeSort {
	/*
	 * Basic Plan 1. divide array into 2 halves 2. Recursively sort each half 3.
	 * Merge two halves
	 * 
	 */
	 ...
	 * into two halves: middle m = (l+r)/2 2. Call mergeSort for first half: Call
	 * mergeSort(arr, l, m) 3. Call mergeSort for second half: Call mergeSort(arr,
	 * m+1, r) 4. Merge the two halves sorted in step 2 and 3: Call merge(arr, l,
	 * m,r)
	 */
