 ...
 * Loterij klasse.
 * 
 * Klanten kunnen zich registereren. Klanten kunnen loten kopen (half lot of
 * heel lot).
 * 
...
public class Loterij {
	 ...
	 * 
	 * Er wordt gecontrolleerd of de klant wel geregistreerd is. Zo ja, dan wordt
	 * een lot gekocht en bij de klant opgeslagen. Het nummer van de lot wordt
	 * geretourneerd.
	 * 
