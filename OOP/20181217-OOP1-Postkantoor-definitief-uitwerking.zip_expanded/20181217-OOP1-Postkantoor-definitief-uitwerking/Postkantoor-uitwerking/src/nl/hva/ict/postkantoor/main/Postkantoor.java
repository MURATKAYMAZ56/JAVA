...
public class Postkantoor {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welkom bij Postkantoor HvA");
    ...
    /**
     * Print alle brieven die aan een bepaalde plaats zijn geadresseerd.
     * 
     * @param zending De verzameling Post stukken, waaronder bnrieven.
     * @param plaats De gevraagde plaats.
     */
